        ...
        for wp2 in wp2_lists:
            for gen in wp1_generators:
                ...
                for i, wp in enumerate(wp2):
                    ...
                    #     i,
                    #     "newbasisorbit",
                    #     SymmOp(new_basis_orbit).as_xyz_string(),
                    #     "oldbasisorbit",
                    #     SymmOp(old_basis_orbit).as_xyz_string(),
                    #     "chosenwyckoff",
                    #     wp.as_xyz_string(),
                    # )
                    ...
                    if i == 0:
                        ...
                        if not in_lists(tmp, wp1_generators_visited) and in_lists(tmp, wp1_generators) and truth:
                            ...
                            break
                    # to consider PBC
                    # print(SymmOp(old_basis_orbit).as_xyz_string(),'   ',SymmOp(new_basis_orbit).as_xyz_str(),'    ',wp.as_xyz_str())
